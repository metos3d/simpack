...
Assuming \href{http://www.mcs.anl.gov/petsc/}{PETSc}, version 3.1 or higher,
is installed do the following:

\begin{enumerate}
\item Prepare the data. See \href{http://www.informatik.uni-kiel.de/~algopt/metos3d/data/}{Metos3D Data} for more.
\item Request package \texttt{metos3d-0.1-simpack.tar.gz} by email from \url{jpi@informatik.uni-kiel.de} or
\url{ts@informatik.uni-kiel.de}
%\item Download the software package. Example:
%\begin{verbatim}
%$>
%wget http://www.informatik.uni-kiel.de/~algopt/metos3d/packs/simpack/\
%metos3d-0.1-simpack.tar.gz
%\end{verbatim}
\item Uncompress and unarchive it. Example:
\begin{verbatim}
$>
gunzip metos3d-0.1-simpack.tar.gz
tar xf metos3d-0.1-simpack.tar
\end{verbatim}
%
\item Download a model. See \href{http://www.informatik.uni-kiel.de/~algopt/metos3d/models/}{Metos3D Models} for more.
%
\item Change into the package root directory and set the PETSc environment variables. Example:
\begin{verbatim}
metos3d-0.1-simpack $>
. petsc/de.uni-kiel.rz.rzcluster.petsc.opt.txt
\end{verbatim}
%
\item Choose a BGC model to compile Metos3D with. Example:
\begin{verbatim}
metos3d-0.1-simpack $>
make BGC=models/I-Cs/
\end{verbatim}
%\textbf{Note:} The last slash '/' must be provided!
%
\item Run the executable. Example:
\begin{verbatim}
metos3d-0.1-simpack $>
./metos3d-0.1-I-Cs.exe models/I-Cs/options/de.uni-kiel.rz.rzcluster.option.I-Cs.txt 
\end{verbatim}
\end{enumerate}
